          ...
          <div className="w-full max-w-md px-4  text-gray-600 sm:px-0">
            <div className="">
              <div className="mt-5 space-y-1">
                <h3 className="text-primary-teal text-center text-2xl font-bold sm:text-3xl">
                  Register
                </h3>
              </div>
            </div>
            ...
            >
              ...
              <button className="w-full px-4 py-2 text-white font-medium bg-primary-teal hover:bg-green-900 active:bg-primary-teal rounded-lg duration-150">
                Create account
              </button>
            </form>
          </div>
