  ...
  const testimonials = [
    {
      ...
      quote:
        "PharmaMart has completely transformed the way I order medicines for my clinic. The service is fast, reliable, and the product quality is unmatched.",
    },
    {
      ...
      quote:
        "I love how PharmaMart makes it so easy to find the right supplements for my fitness goals. Highly recommended!",
    },
    {
      ...
      quote:
        "PharmaMart's user-friendly interface and timely delivery have made managing my health so much easier. Thank you for such excellent service!",
    },
  ];
    ...
    <section className="relative py-14">
      <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
        <div className="max-w-xl sm:text-center md:mx-auto">
          ...
          <p className="mt-3">
            At PharmaMart, your trust means everything to us. Here's what our
            satisfied customers have to say about their experience: reliable
            products, timely deliveries, and exceptional service. Join the
            PharmaMart family and experience the difference!
          </p>
        </div>
        <div className="mt-12">
          <ul className="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((item, idx) => (
              <li
                key={idx}
                className={`${mode === 'light' ? "bg-white" : "bg-slate-400"} rounded-xl border shadow-md`}
              >
                <div className="p-4">
                  <svg
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(152.92deg,rgba(0, 161, 157, 0.2) 4.54%, rgba(0, 161, 157, 0.17) 34.2%,rgba(0,161, 157, 0.1) 77.55%)",
        }}
      ></div>
    </section>
  );
